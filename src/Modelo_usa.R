...
llike_suave_usa2 <- function(pars){
...
# Verossimilhanca do modelo com transição suave - INICIO
llike_suave_usa_arch <- function(pars){
...
estimando_usa <- function(model, pars_init){
