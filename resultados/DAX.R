...
p3 <- ggplot(DAX, aes(x = Index, y = dax)) +
  ...
  theme_minimal() + 
  geom_vline(xintercept = c(crises, as.Date("2008-09-20")), 
...
dummy2 <- as.matrix(dummy_on_off(n, c(1, 896, 1257),
                                 c(895, 1256, n)))
...
ggplot(DAX, aes(x = Index, y = dax)) +
  ...
  labs(x = "Tempo", y = "Retorno", title = "DAX com as Restrições") +
  theme_minimal() + 
  geom_vline(xintercept = c(crises[1], as.Date("2008-09-20"), crises[2]), 
             colour = c('red', 'red', 'red'), size = 1.5,
             linetype = "dashed")
...
dummy1 <- as.matrix(dummy_step(n, 1, "Media"))
dummy2 <- as.matrix(dummy_on_off(n, c(1, 896, 1208, 1257),
                                 c(895, 1207, 1256, n)))
# Ordens e Parametros - FIM
...
ggplot(DAX, aes(x = Index, y = dax)) +
  ...
  labs(x = "Tempo", y = "Retorno", title = "DAX com as Restrições") +
  theme_minimal() + 
  geom_vline(xintercept = c(crises[1], as.Date("2008-09-15"), crises[2]), 
             colour = c('red', 'red', 'red'), size = 1.5,
             linetype = "dashed")
...
dummy1 <- as.matrix(dummy_step(n, 1, "Media"))
dummy2 <- as.matrix(dummy_on_off(n, c(1, 896, 1203, 1257),
                                 c(895, 1202, 1256, n)))
# Ordens e Parametros - FIM
...
dummy1 <- as.matrix(dummy_step(n, 1, "Media"))
dummy2 <- as.matrix(dummy_on_off(n, c(1, 896, 1203, 1208, 1257),
                                 c(895, 1202, 1207, 1256, n)))
# Ordens e Parametros - FIM
...
dummy1 <- as.matrix(dummy_step(n, 1, "Media"))
dummy2 <- as.matrix(dummy_on_off(n, c(1, 896, 1256),
                                 c(895, 1207, n)))
# Ordens e Parametros - FIM
